...
* `Issue #306 <https://bitbucket.org/pypa/setuptools/issue/306>`_: Suppress warnings about Version format except in select scenarios
...
* `Pull Request #85 <https://bitbucket.org/pypa/setuptools/pull-request/85>`_: Search egg-base when adding egg-info to manifest.
